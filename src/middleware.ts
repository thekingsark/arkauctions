...
const SIGN_IN_PROTECTED_ROUTES = ["auction-create", "auction-update", "profile", "recommendations", "last-seen"]
...
export function middleware(req: NextRequest) {
  ...
  if (req.nextUrl.pathname.startsWith(`/api`)) {
    if (!req.headers.get("referer")?.includes(process.env.APP_URL || "") && req.nextUrl.pathname !== revalidatePath) {
